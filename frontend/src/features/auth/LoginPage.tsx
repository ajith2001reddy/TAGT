    ...
    const handleGoogleLogin = async () => {
        ...
        try {
            ...
            if (err.code === "auth/popup-closed-by-user") {
                setError("") // user just closed the popup, not an error
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-zinc-950 text-white">
            <div className="bg-zinc-900 border border-zinc-800 p-8 rounded-2xl w-full max-w-sm space-y-6">
                <div>
                    <h1 className="text-2xl font-bold">TAGT</h1>
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full flex items-center justify-center gap-3 bg-white text-zinc-900 hover:bg-zinc-100 disabled:opacity-50 px-4 py-3 rounded-lg font-medium transition"
                >
                ...
                <form onSubmit={handleEmailLogin} className="space-y-4">
                    <input
                        type="email"
                        placeholder="Email"
                        className="w-full p-3 rounded-lg bg-zinc-800 border border-zinc-700 focus:outline-none focus:border-blue-500 transition"
                        value={email}
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-50 p-3 rounded-lg font-semibold transition"
                    >
