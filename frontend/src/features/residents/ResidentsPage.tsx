    ...
    return (
        <div className="space-y-6 max-w-6xl">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                    ...
                    <p className="text-sm text-white/40">
                        {activeCount} active · {residents.length - activeCount} inactive
                    </p>
                </div>
                <input
            ...
            <form
                ...
                className="grid md:grid-cols-6 gap-2 rounded-2xl border border-white/10 p-3 bg-white/[0.02]"
            >
                <input
                ...
                <button
                    disabled={saving}
                    className="bg-violet-500 disabled:opacity-60 rounded text-white"
                >
                    {saving ? "Saving..." : "Add"}
                </button>
            </form>
            ...
            <div className="rounded-2xl border border-white/10 overflow-hidden">
                <table className="w-full text-sm">
                    ...
                    <tbody>
                        {loading ? (
                            <tr>
                                <td className="p-6 text-white/50" colSpan={5}>
                                    Loading residents...
                                </td>
                            </tr>
                            ...
                            filteredResidents.map((resident) => (
                                ...
                                >
                                    ...
                                    <td className="p-3 text-right space-x-3">
                                        <button
                                            onClick={() => openProfile(resident._id)}
            ...
            {/* Modals stay here */}
            {profile && (
                <div> ...your profile modal code... </div>
            )}
